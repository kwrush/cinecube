...
const people = new schema.Entity('people', { known_for: [mediaTypes] });
// Used to normalize resutls returned from 'popular people' or 'search'
const peopleResults = new schema.Entity('results', { known_for: [mediaTypes] });
// Used to normalize results contains multiple media types
const multiTypes = new schema.Union({
  movie: movie,
  tv: tv,
  people: people
}, 'media_type'); 
...
module.exports = {
  ...
  multiResults: { results: [multiTypes]},
  genreResults
};